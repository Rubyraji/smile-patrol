...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'longwalk', emoji: '🥾', name: 'Long Walk',           category: 'exercise', cost: 5,  description: 'A big adventure on foot!' },
  { id: 'swim',     emoji: '🏊', name: 'Swimming',            category: 'exercise', cost: 5,  description: 'Splash and glide through the water!' },
...
export const REWARD_STICKERS: Array<{ emoji: string; name: string }> = [
  ...
  { emoji: '🌙', name: 'Moon Walker' },
  { emoji: '☀️', name: 'Sunshine Star' },
  { emoji: '🦋', name: 'Magic Butterfly' },
  { emoji: '🍀', name: 'Lucky Brusher' },
  { emoji: '🎨', name: 'Art Master' },
  { emoji: '🦁', name: 'Brave Lion' },
  { emoji: '🌊', name: 'Ocean Hero' },
  { emoji: '🎵', name: 'Melody Maker' },
  { emoji: '🐬', name: 'Dolphin Dash' },
  { emoji: '🧙', name: 'Wizard Brusher' },
  { emoji: '🦅', name: 'Eagle Eye' },
  { emoji: '🌸', name: 'Cherry Blossom' },
  { emoji: '🎸', name: 'Rock Star' },
  { emoji: '🦊', name: 'Clever Fox' },
  { emoji: '🍭', name: 'Sweet Victory' },
  { emoji: '🌺', name: 'Flower Power' },
  { emoji: '🧸', name: 'Teddy Champion' },
  { emoji: '🏄', name: 'Wave Rider' },
  { emoji: '🦜', name: 'Parrot Pal' },
  { emoji: '🌻', name: 'Sunflower Star' },
  { emoji: '🐙', name: 'Octopus Arms' },
  { emoji: '🦚', name: 'Peacock Pride' },
  { emoji: '🏔️', name: 'Mountain Climber' },
  { emoji: '🎯', name: 'Bullseye!' },
  { emoji: '🌍', name: 'World Explorer' },
  { emoji: '🐠', name: 'Tropical Fish' },
  { emoji: '🦝', name: 'Raccoon Scout' },
  { emoji: '🎪', name: 'Big Top Star' },
  { emoji: '🧲', name: 'Magnet Mind' },
  { emoji: '🌵', name: 'Desert Champion' },
  { emoji: '🎭', name: 'Drama Star' },
  { emoji: '🦩', name: 'Flamingo Dancer' },
  { emoji: '🍦', name: 'Ice Cream Reward' },
  { emoji: '🎲', name: 'Lucky Roll' },
  { emoji: '🐧', name: 'Cool Penguin' },
  { emoji: '🧨', name: 'Firecracker!' },
  { emoji: '🌮', name: 'Taco Tuesday' },
  { emoji: '🦖', name: 'Dino Chomper' },
  { emoji: '💎', name: 'Diamond Brusher' },
];
 ...
 * Each heart is worth 5 points spent in the shop this week. A partial heart (any
 * remainder) displays as a half-full heart on the card.
 */
export function getPetHappiness(kid: Kid, weekDays: Date[]): number {
  const weekStart = format(startOfWeek(new Date(), { weekStartsOn: 1 }), 'yyyy-MM-dd');
  const todayStr  = format(new Date(), 'yyyy-MM-dd');

  const pointsSpentThisWeek = (kid.purchases ?? [])
    .filter((p) => {
  ...
  // 5 points spent = 1 full heart; returns float so partial hearts can be shown
  return Math.min(5, pointsSpentThisWeek / 5);
}
